...
import 'package:mobile/app_files/Database/RegistrationDetail.dart';
...
Future<void> updateRegistration(String regToUpdate) async {
  final SharedPreferences prefs = await SharedPreferences.getInstance();
  String? updateEmail = prefs.getString('email');

  var url = Uri.parse("http://10.0.2.2:8080/backend/update_registration");

  url = Uri.http(url.authority, url.path, {"Registration_Id": regToUpdate});
