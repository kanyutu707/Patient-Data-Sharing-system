...
public class VincentyFormula {
    ...
    private static final double SEMI_MAJOR_AXIS_MT = 6378137.0;
    private static final double SEMI_MINOR_AXIS_MT = 6356752.314245;
    private static final double ERROR_TOLERANCE = 1e-12;

    /**
     * Calculates the distance between two points using Vincenty formula.
     *
    ...
    public double calculateDistance(double latitude1, double longitude1, double latitude2, double longitude2) {
        ...
        return distanceMt / 1000; // Convert meters to kilometers
    }
}
