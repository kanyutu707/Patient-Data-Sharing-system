...
5. Modules
6. How It Works
7. Emergency Face-Scan Protocol
...
#### Medical Officer Portal (Angular)
...
#### Face Recognition Service (FastAPI + TensorFlow)
